...
@rem ##########################################################################
@rem
@rem  hw01chris startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and HW01CHRIS_OPTS to pass JVM options to this script.
...
@rem Execute hw01chris
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HW01CHRIS_OPTS%  -classpath "%CLASSPATH%" edu.ou.cs.cg.assignment.solution01.Application %*
...
:fail
rem Set variable HW01CHRIS_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%HW01CHRIS_EXIT_CONSOLE%" exit 1
exit /b 1
